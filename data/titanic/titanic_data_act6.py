...
def display_num_survived():
    ...
    for record in records:                              # For the row in the list 'records'
        survival_status_str = record[1]                 # Add the info in the second column (index 1) to the variable 'survival status'
        survival_status = int(survival_status_str)      # Converts string to integer
